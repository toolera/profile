...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="relative pt-16 pb-20 flex flex-col justify-center min-h-[100vh] bg-mesh-gradient bg-[length:200%_200%] animate-gradient overflow-hidden"
    >
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-3 text-white drop-shadow-lg">
            <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">Ismat</span> Samadov
          </h1>
          <div className="text-lg sm:text-xl md:text-2xl font-medium mb-4 text-white drop-shadow-md h-8">
            <span>{typedText}</span>
          ...
          <motion.div 
            ...
            className="mb-8 bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 shadow-xl"
          >
            <p className="text-white/90 mb-3 text-sm sm:text-base md:text-lg max-w-2xl mx-auto">
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="w-full sm:w-auto inline-block bg-gradient-to-r from-purple-500 to-pink-500 text-white font-medium py-3 px-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 text-center"
            ...
            <DownloadButton
              ...
              label="Download CV"
              className="w-full sm:w-auto py-3 px-6 bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white border border-white/30 rounded-xl transition-all duration-300"
              variant="secondary"
              documentType="cv"
            />
          </motion.div>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <motion.div
          ...
          className="absolute top-40 right-20 w-16 h-16 bg-purple-400/20 rounded-lg blur-sm"
        />
        <motion.div
          animate={{ 
            x: [0, 80, 0],
          ...
          className="absolute bottom-40 left-1/4 w-12 h-12 bg-pink-400/20 rounded-full blur-sm"
        />
      </div>
